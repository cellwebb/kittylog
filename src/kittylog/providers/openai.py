...
def call_openai_api(
    ...
    try:
        ...
        raise AIError.generation_error("OpenAI API request timed out") from e
    except httpx.RequestError as e:
        raise AIError.generation_error(f"OpenAI API network error: {e}") from e
    except (KeyError, IndexError, TypeError) as e:
        raise AIError.generation_error(f"OpenAI API invalid response format: {e}") from e
