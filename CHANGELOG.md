...
- Unreleased mode for changelog generation to process commits since last tag

### Changed

- Update default AI model configurations to latest versions (gpt-5-mini, claude-haiku-4-5, gpt-oss-20b)
