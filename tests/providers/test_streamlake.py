...
API_KEY = "test-key"
API_ENDPOINT = "https://vanchin.streamlake.ai/api/gateway/v1/endpoints/chat/completions"
...
class TestStreamlakeProvider:
    ...
    def test_call_streamlake_api_success(self, mock_post, dummy_messages, mock_http_response_factory, api_test_helper):
        ...
        result = PROVIDER_REGISTRY["streamlake"](
            model="gpt-4",
    ...
    def test_call_streamlake_api_missing_api_key(self, monkeypatch, dummy_messages):
        ...
        with pytest.raises(AIError) as exc_info:
            PROVIDER_REGISTRY["streamlake"]("test-model", dummy_messages, 0.7, 32)
    ...
    @pytest.mark.skipif(not os.getenv("STREAMLAKE_API_KEY"), reason="STREAMLAKE_API_KEY not set")
